...
import stylesCss from 'themes/vaadin-grids/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vaadin-grids_componentCss']) {
    
    document['_vaadintheme_vaadin-grids_componentCss'] = true;
  }
